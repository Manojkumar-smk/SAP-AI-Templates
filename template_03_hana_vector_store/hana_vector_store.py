...
def get_embedding_model():
    ...
    Supported embedding models via SAP Gen AI Hub:
      "text-embedding-ada-002"  → 1536 dims (default, most compatible)
      "text-embedding-3-small"  → 1536 dims (newer, faster)
      "text-embedding-3-large"  → 3072 dims (highest quality)
    Change EMBEDDING_MODEL and VECTOR_DIMENSION at the top to switch.
    """
