...
Dependencies:
    pip install hdbcli hana-ml gen-ai-hub langchain langchain-openai pandas python-dotenv
...
def get_llm():
    ...
    from langchain_openai import ChatOpenAI as DirectOpenAI
    return DirectOpenAI(model="gpt-4o-mini", temperature=0,
